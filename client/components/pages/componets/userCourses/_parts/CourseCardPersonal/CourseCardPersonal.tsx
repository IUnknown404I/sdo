...
import { ICourseCardPersonalProps } from './CourseCardPersonal.props';

export const CourseCardPersonal = (props: ICourseCardPersonalProps) => {
	return (
		<Card sx={{ borderRadius: '20px' }}>
			<OnyxLink href={props.actionLink} blockElement>
				<CardActionArea>
					<Stack
						direction={'row'}
						...
						<CardContent sx={{ width: '100%' }}>
							...
							>
								<Stack direction='column' justifyContent='space-between' spacing={3}>
									...
									<Box>
										<OnyxTypography text={props.typeCourse} tpVariant='overline' tpColor='secondary' />
...
function CircularProgressWithLabel(props: CircularProgressProps & { value: number }) {
	return (
		<Box sx={{ position: 'relative', display: 'inline-flex' }}>
			...
			>
				<OnyxTypography tpVariant='body1' component='div' tpColor='secondary' text={`${Math.round(props.value)}%`} />
			</Paper>
		</Box>
	);
}
