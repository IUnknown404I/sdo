const EmailChangeTemplate = (props: { date: string; oldEmail: string; newEmail: string; verificationLink: string }) => {
	return `
                                                                ...
                                                                <table cellPadding="0" cellSpacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            <img
                                                                                src="https://corp-assets.clicktravel.com/wp-content/uploads/2018/09/11131025/iStock-878935262.jpg"
                                                                                alt="Emailing"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" style="padding:0;Margin:0">
                                                                            <h2 style="Margin:0;line-height:31px;font-family:Montserrat,sans-serif;font-size:26px;font-style:normal;font-weight:normal;color:#333333">Смена контактной электронной почты</h2></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" style="padding:5px;Margin:0"><p style="Margin:0;font-family:Montserrat,sans-serif;line-height:19px;color:#333333;font-size:16px">Подтвердите, что в ${props.date} по Мск&nbsp;Вы отправили заявку на изменение подтвержденной почты&nbsp;<em><strong><a title="Написать письмо"
                                                                                    href="mailto:${props.oldEmail}"
                                                                                    style="text-decoration:none;color:#134f5c;font-size:16px"
                                                                                    target="_blank">${props.oldEmail}
                                                                                </a></strong></em>&nbsp;на новый электронный адрес&nbsp;<em><strong><a title="Написать письмо"
                                                                                    href="mailto:${props.newEmail}"
                                                                                    style="text-decoration:none;color:#134f5c;font-size:16px"
                                                                                    target="_blank">${props.newEmail}
                                                                                </a></strong></em>&nbsp;в своем личном кабинете на <em><strong><a title="Перейти к СДО"
