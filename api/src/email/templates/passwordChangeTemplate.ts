const PasswordChangeTemplate = (props: { datetime: string; recoveryLink: string }) => {
	return `
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <p style="Margin:0;font-family:Montserrat,sans-serif;line-height:19px;color:#333333;font-size:16px"><br></p>
                                                                            <p style="Margin:0;font-family:Montserrat,sans-serif;line-height:19px;color:#333333;font-size:16px">Подтвердите,
                                                                                ...
                                                                                МСК&nbsp;Вами&nbsp;была&nbsp;сформирована&nbsp;
                                                                                <br>заявка&nbsp;на&nbsp;изменение&nbsp;пароля&nbsp;на <em><strong><a title="Перейти к СДО"
