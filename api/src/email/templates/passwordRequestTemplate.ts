const PasswordRequestTemplate = (props: { password: string; date: string }) => {
	return `
    <div style="width:100%;font-family:Montserrat,sans-serif;padding:0;Margin:0">
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top"
                                                                ...
                                                                <table cellPadding="0" cellSpacing="0" width="100%"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" style="padding:0;Margin:0">
                                                                            <h2 style="Margin:0;line-height:31px;font-family:Montserrat,sans-serif;font-size:26px;font-style:normal;font-weight:normal;color:#333333">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <p style="Margin:0;font-family:Montserrat,sans-serif;line-height:19px;color:#333333;font-size:16px"><br></p>
                                                                            <p style="Margin:0;font-family:Montserrat,sans-serif;line-height:19px;color:#333333;font-size:16px">Это письмо было сгенерировано и отправлено, потому что из Вашего личного кабинета <em><strong><a title="Перейти к СДО" href="https://umcmrg.ru" style="text-decoration:none;color:#134f5c;font-size:16px" target="_blank">нашей образовательной платформе</a></strong></em> в ${props.date} поступил запрос на получение пароля учетной записи. 
<br><br>
Если это были не вы, проигнорируйте данное письмо и сообщите о случившемся технической поддержке.&nbsp; <br>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center"
                                                                      ...
                                                                      <tr>
                                                                        <td align="center" style="padding:5px;Margin:0">
                                                                        <p style="Margin:0;font-family:Montserrat,sans-serif;line-height:19px;color:#333333;font-size:16px"><br></p>
                                                                            <p style="Margin:0;font-family:Montserrat,sans-serif;line-height:19px;color:#333333;font-size:16px">Ваш текущий пароль:<br>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center"
                                                                            ...
                                                                            <span
                                                                                style="border-style:solid;border-color:#999999;background:#ffffff;border-width:1px;display:inline-block;border-radius:0px;width:auto"><span title="Перейти к восстановлению"
                                                                                ...
                                                                                target="_blank">${props.password}</span></span>
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                                                </table>
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" style="padding:0;Margin:0"><p
                                                                            ...
                                                                            веб-сайтами, <br>Вы соглашаетесь с&nbsp;<a title="Перейти к документу"
                                                                                ...
                                                                                style="text-decoration:underline;color:#134f5c;font-size:12px" title="Перейти"
...
export default PasswordRequestTemplate;
